        ...
        modules: [
            {
                ...
                quiz: {
                    titulo: "Prueba sobre Metrología",
                    descripcion: "Evalúa tus conocimientos sobre la definición y el alcance de la metrología.",
                    questions: [
                        {
                            question: "¿Qué estudia la metrología?",
                            options: [
                                "La física de las partículas",
                                "Las mediciones y sus aplicaciones",
                                "El comportamiento de los fluidos"
                            ],
                            correctAnswer: "Las mediciones y sus aplicaciones"
                        },
                        {
                            question: "¿Cuál es el propósito principal de la metrología?",
                            options: [
                                "Crear nuevos sistemas de unidades",
                                "Garantizar la precisión y confiabilidad de las mediciones",
                                "Medir la temperatura de manera exacta"
                            ],
                            correctAnswer: "Garantizar la precisión y confiabilidad de las mediciones"
                        },
                        {
                            question: "¿Qué incluye el alcance de la metrología?",
                            options: [
                                "La investigación científica exclusivamente",
                                "Sistemas de medición, patrones de referencia y trazabilidad internacional",
                                "El estudio de las estrellas"
                            ],
                            correctAnswer: "Sistemas de medición, patrones de referencia y trazabilidad internacional"
                        }
                    ]
                },
                content: [
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732293012/Qu%C3%A9_es_Metrolog%C3%ADa_vxhbdn.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732293735/Importancia_de_la_Metrolog%C3%ADa_z26wq4.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732298794/Historia_de_la_Metrolog%C3%ADa_xpcelo.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
            ...
            },
            {
                ...
                quiz: {
                    titulo: "Prueba sobre Conceptos Matemáticos Aplicados",
                    descripcion: "Evalúa tus conocimientos sobre conceptos clave como promedio, desviación estándar y notación científica.",
                    questions: [
                        {
                            question: "¿Cómo se calcula el promedio de un conjunto de datos?",
                            options: [
                                "Sumando todos los valores y multiplicando por la cantidad de datos",
                                "Sumando todos los valores y dividiéndolos por la cantidad total de datos",
                                "Sumando todos los valores y dividiéndolos por 10"
                            ],
                            correctAnswer: "Sumando todos los valores y dividiéndolos por la cantidad total de datos"
                        },
                        {
                            question: "¿Qué mide la desviación estándar?",
                            options: [
                                "La diferencia entre el valor más alto y el más bajo",
                                "La dispersión de los datos en torno al promedio",
                                "El valor central de un conjunto de datos"
                            ],
                            correctAnswer: "La dispersión de los datos en torno al promedio"
                        },
                        {
                            question: "¿Cuál es el objetivo principal de la notación científica?",
                            options: [
                                "Expresar números de forma compacta usando potencias de 10",
                                "Sumar números grandes rápidamente",
                                "Restar números muy pequeños"
                            ],
                            correctAnswer: "Expresar números de forma compacta usando potencias de 10"
                        }
                    ]
                },
                content: [
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299102/Promedio_gatxqt.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299103/Desviaci%C3%B3n_Est%C3%A1ndar_wysvhd.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299101/Notaci%C3%B3n_Cient%C3%ADfica_g8qy32.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
            ...
            },
            {
                ...
                quiz: {
                    titulo: "Prueba sobre Magnitudes y Unidades",
                    descripcion: "Evalúa tus conocimientos sobre las magnitudes, unidades de medida y su conversión.",
                    questions: [
                        {
                            question: "¿Cuál es la principal diferencia entre las magnitudes fundamentales y las derivadas?",
                            options: [
                                "Las magnitudes fundamentales son siempre mayores que las derivadas.",
                                "Las magnitudes derivadas son combinaciones de magnitudes fundamentales.",
                                "Las magnitudes fundamentales solo se utilizan en el Sistema Internacional de Unidades."
                            ],
                            correctAnswer: "Las magnitudes derivadas son combinaciones de magnitudes fundamentales."
                        },
                        {
                            question: "¿Cuál de las siguientes es una unidad base del Sistema Internacional de Unidades?",
                            options: [
                                "Newton (N)",
                                "Kilogramo (kg)",
                                "Joule (J)"
                            ],
                            correctAnswer: "Kilogramo (kg)"
                        },
                        {
                            question: "¿Qué componente forma parte de un sistema de unidades?",
                            options: [
                                "Magnitudes físicas base",
                                "Sólo prefijos para múltiplos",
                                "Factores de conversión"
                            ],
                            correctAnswer: "Magnitudes físicas base"
                        },
                        {
                            question: "¿Cuál es la importancia de la conversión de unidades?",
                            options: [
                                "Permite cambiar el valor de las magnitudes.",
                                "Garantiza que las mediciones sean consistentes en diferentes contextos.",
                                "Solo se utiliza para convertir unidades de longitud."
                            ],
                            correctAnswer: "Garantiza que las mediciones sean consistentes en diferentes contextos."
                        },
                        {
                            question: "¿Qué instrumento se utiliza para medir con precisión la longitud?",
                            options: [
                                "Micrómetro",
                                "Manómetro",
                                "Termómetro"
                            ],
                            correctAnswer: "Micrómetro"
                        }
                    ]
                },
                content: [
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299820/Magnitudes_ediccb.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299822/Unidades_de_Medida_euux2s.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299821/Sistemas_de_Unidades_e2j1k9.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299818/Conversi%C3%B3n_de_Unidades_fqftki.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    {
                        subtitle: "Instrumentos de Medida",
                        description: "Tipos de instrumentos para medir magnitudes y su funcionamiento.",
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732299819/Instrumentos_de_Medida_vlypui.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                        ...
                        desarrollo: "Los instrumentos de medida son herramientas fundamentales para obtener datos cuantitativos precisos de magnitudes. Algunos ejemplos comunes son los calibradores, micrómetros, termómetros, manómetros y balanzas. Estos instrumentos están diseñados para medir con alta precisión propiedades físicas específicas, y su correcta calibración es esencial para obtener resultados fiables. Además, existen instrumentos especializados para la medición de magnitudes complejas como la fuerza, el volumen o la velocidad, cada uno adaptado a su aplicación particular."
                    }
                ]
            },
            {
                ...
                quiz: {
                    titulo: "Prueba sobre Características de las Mediciones",
                    descripcion: "Evalúa tus conocimientos sobre la precisión, exactitud e incertidumbre en las mediciones.",
                    questions: [
                        {
                            question: "¿Cuál es la principal diferencia entre precisión y exactitud?",
                            options: [
                                "La precisión mide cuán cerca está un resultado del valor verdadero, y la exactitud mide la consistencia.",
                                "La precisión se refiere a la consistencia de los resultados, y la exactitud mide cuán cerca está de un valor verdadero.",
                                "La precisión y la exactitud son lo mismo."
                            ],
                            correctAnswer: "La precisión se refiere a la consistencia de los resultados, y la exactitud mide cuán cerca está de un valor verdadero."
                        },
                        {
                            question: "¿Es posible que un sistema de medición sea preciso pero inexacto?",
                            options: [
                                "Sí, si las mediciones son consistentes pero están alejadas del valor verdadero.",
                                "No, la precisión siempre garantiza exactitud.",
                                "No, la precisión y la exactitud siempre van de la mano."
                            ],
                            correctAnswer: "Sí, si las mediciones son consistentes pero están alejadas del valor verdadero."
                        },
                        {
                            question: "¿Qué es la incertidumbre en las mediciones?",
                            options: [
                                "Es una estimación cuantitativa del error en una medición.",
                                "Es la exactitud del instrumento de medición.",
                                "Es el rango de posibles valores en una medición."
                            ],
                            correctAnswer: "Es el rango de posibles valores en una medición."
                        },
                        {
                            question: "¿Qué factores pueden influir en la incertidumbre de una medición?",
                            options: [
                                "Solo el instrumento de medición.",
                                "Las condiciones ambientales, el instrumento y el método de medición.",
                                "El valor real de la magnitud medida."
                            ],
                            correctAnswer: "Las condiciones ambientales, el instrumento y el método de medición."
                        },
                        {
                            question: "¿Por qué es importante interpretar la incertidumbre en las mediciones?",
                            options: [
                                "Para garantizar que la medición sea siempre exacta.",
                                "Para evaluar la confiabilidad de los resultados y tomar decisiones informadas.",
                                "Para saber qué unidades usar."
                            ],
                            correctAnswer: "Para evaluar la confiabilidad de los resultados y tomar decisiones informadas."
                        }
                    ]
                },
                content: [
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732300051/12_blbzjs.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732300052/13_vqg3np.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
            ...
            },
            {
                ...
                quiz: {
                    titulo: "Prueba sobre Calibración y Documentación",
                    descripcion: "Evalúa tus conocimientos sobre el proceso de calibración y los certificados de calibración.",
                    questions: [
                        {
                            question: "¿Qué es la calibración de un instrumento de medición?",
                            options: [
                                "Es el proceso de ajustar un instrumento para que siempre dé el valor máximo.",
                                "Es el proceso de comparar un instrumento con un estándar de referencia conocido para identificar y corregir desviaciones.",
                                "Es el proceso de limpiar un instrumento para garantizar su correcto funcionamiento."
                            ],
                            correctAnswer: "Es el proceso de comparar un instrumento con un estándar de referencia conocido para identificar y corregir desviaciones."
                        },
                        {
                            question: "¿Por qué es importante realizar calibraciones periódicas en los instrumentos de medición?",
                            options: [
                                "Porque garantiza que los instrumentos mantengan resultados confiables y trazables.",
                                "Porque permite que los instrumentos se usen durante más tiempo.",
                                "Porque disminuye el costo de los instrumentos."
                            ],
                            correctAnswer: "Porque garantiza que los instrumentos mantengan resultados confiables y trazables."
                        },
                        {
                            question: "¿Qué información se incluye típicamente en un certificado de calibración?",
                            options: [
                                "El nombre del operador, el modelo del instrumento y las fechas de uso.",
                                "La identificación del instrumento, las condiciones ambientales, los resultados de la calibración y la incertidumbre asociada.",
                                "Solo los resultados numéricos obtenidos durante la calibración."
                            ],
                            correctAnswer: "La identificación del instrumento, las condiciones ambientales, los resultados de la calibración y la incertidumbre asociada."
                        },
                        {
                            question: "¿Qué significa la trazabilidad de las mediciones?",
                            options: [
                                "Que las mediciones se pueden realizar sin errores.",
                                "Que los resultados de las mediciones se pueden relacionar con estándares internacionales a través de la calibración.",
                                "Que las mediciones son precisas y exactas."
                            ],
                            correctAnswer: "Que los resultados de las mediciones se pueden relacionar con estándares internacionales a través de la calibración."
                        },
                        {
                            question: "¿Por qué es importante interpretar cuidadosamente un certificado de calibración?",
                            options: [
                                "Para verificar que el instrumento esté listo para el siguiente uso.",
                                "Para garantizar que el instrumento cumpla con las normativas y estándares internacionales y evaluar su conformidad.",
                                "Para saber cuánto tiempo se puede usar el instrumento sin recalibrarlo."
                            ],
                            correctAnswer: "Para garantizar que el instrumento cumpla con las normativas y estándares internacionales y evaluar su conformidad."
                        }
                    ]
                },
                content: [
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732300276/Calibraci%C3%B3n_vrwpt8.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
                    ...
                    },
                    {
                        ...
                        image: "https://res.cloudinary.com/dc0aja7yx/image/upload/v1732300275/Certificados_de_Calibraci%C3%B3n_dyl4ig.png",
                        interactiveElements: [
                            {
                                video: {
                                    titulo: "",
